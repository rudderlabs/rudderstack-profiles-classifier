...
class MLTrainer(ABC):
    ...
    def train_model(self, feature_df: pd.DataFrame,
        ...
        preprocessor_pipe_x = self.get_preprocessing_pipeline(numeric_columns, categorical_columns, self.prep.numeric_pipeline.get("pipeline"), self.prep.categorical_pipeline.get("pipeline"))
        ...
        results = self.get_metrics(pipe, train_x, train_y, test_x, test_y, val_x, val_y, train_config)
