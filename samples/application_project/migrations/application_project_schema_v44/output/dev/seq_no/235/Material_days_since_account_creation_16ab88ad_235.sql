...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_16AB88AD_235_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION AS (
            ...
            SELECT
                user_main_id,
                 datediff(day, date(min(timestamp)), date('2023-12-21 06:47:32')) 
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_USER_VAR_TABLE_79CC6BE9_235NEW AS (
              ...
              LEFT JOIN MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_16AB88AD_235_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_16AB88AD_235_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION;  
