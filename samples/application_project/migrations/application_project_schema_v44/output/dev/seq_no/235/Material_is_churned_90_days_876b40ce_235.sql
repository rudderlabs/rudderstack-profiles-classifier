   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_IS_CHURNED_90_DAYS_876B40CE_235_INTERNAL_EV_IS_CHURNED_90_DAYS AS (
            
                SELECT * FROM (
            SELECT
                user_main_id,
                case when Material_user_var_table_79cc6be9_235.days_since_last_seen > 90 then 1 else 0 end
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_USER_VAR_TABLE_79CC6BE9_235NEW AS (
              ...
              LEFT JOIN MATERIAL_IS_CHURNED_90_DAYS_876B40CE_235_INTERNAL_EV_IS_CHURNED_90_DAYS USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_IS_CHURNED_90_DAYS_876B40CE_235_INTERNAL_EV_IS_CHURNED_90_DAYS;  
