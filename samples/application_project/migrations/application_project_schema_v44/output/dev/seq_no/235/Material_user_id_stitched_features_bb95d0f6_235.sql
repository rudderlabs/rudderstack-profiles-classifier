   ...
   CREATE OR REPLACE VIEW MATERIAL_USER_ID_STITCHED_FEATURES_BB95D0F6_235 AS 
...
/* endMacros */
    ...
    , distinct_served_ids AS (
        ...
        FROM MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_235
            ...
            ,Material_rudder_user_base_features_3576fcbd_235_ID_MERGED AS (
                ...
                SELECT DISTINCT MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_235.other_id AS user_id
                ...
                WHERE MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_235.other_id_type = 'user_id'
    ...
    distinct_served_ids
            ...
            ON Material_rudder_user_base_features_3576fcbd_235_ID_MERGED.user_id = distinct_served_ids.user_id
            ...
            ON Material_rudder_user_base_features_1_02117404_235_ID_MERGED.user_id = distinct_served_ids.user_id
            ...
            ON Material_shopify_churn_30a1d390_235_ID_MERGED.user_id = distinct_served_ids.user_id
