   ...
   CREATE OR REPLACE VIEW MATERIAL_MAIN_ID_STITCHED_FEATURES_BB95D0F6_239 AS 
...
/* endMacros */
    ...
    , distinct_served_ids AS (
        ...
        FROM MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_239
            ...
            ,Material_rudder_user_base_features_3576fcbd_239_ID_MERGED AS (
                ...
                SELECT DISTINCT MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_239.other_id AS main_id
                ...
                WHERE MATERIAL_RUDDER_USER_ID_STITCHER_9F838BB3_239.other_id_type = 'main_id'
    ...
    distinct_served_ids
            ...
            ON Material_rudder_user_base_features_3576fcbd_239_ID_MERGED.main_id = distinct_served_ids.main_id
            ...
            ON Material_rudder_user_base_features_1_02117404_239_ID_MERGED.main_id = distinct_served_ids.main_id
            ...
            ON Material_shopify_churn_30a1d390_239_ID_MERGED.main_id = distinct_served_ids.main_id
