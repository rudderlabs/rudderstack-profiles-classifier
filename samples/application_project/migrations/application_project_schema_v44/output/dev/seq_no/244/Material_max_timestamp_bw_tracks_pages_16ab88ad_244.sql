...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_16AB88AD_244_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES AS (
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_USER_VAR_TABLE_79CC6BE9_244NEW AS (
              ...
              LEFT JOIN MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_16AB88AD_244_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_16AB88AD_244_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES;  
