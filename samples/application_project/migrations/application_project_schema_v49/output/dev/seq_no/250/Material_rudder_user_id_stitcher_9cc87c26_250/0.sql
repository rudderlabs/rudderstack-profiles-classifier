...
/* endMacros */
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW 
        (
            id1 varchar,
            id1_type varchar,
            id2 varchar,
    ...
    ;  
                        ...
                        INSERT INTO MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW (id1, id1_type, id2, id2_type, valid_at)
    ...
    DELETE FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW WHERE
        id1_type NOT IN (
    ...
    'anonymous_id', 'cart_token', 'email', 'user_id'
                ...
                DELETE FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW WHERE NOT (
   ...
   CREATE OR REPLACE TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES AS 
            SELECT
                id1,
                id1_type,
                id2,
...
,
    ...
    'rid' || left(sha1(concat(left(sha1('fe971b24-9572-4005-b22f-351e9c09274d' || NVL(id2,'')),32),NVL(id2_type,''))),32)
            ...
            FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW
            WHERE
                id1 IS NOT NULL
                AND id1_type IS NOT NULL
                AND id2 IS NOT NULL
        ...
        DROP TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES_RAW;

        
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_ACTIVE_MAPPING 
    (
        node_id varchar,
...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_FINISHED_MAPPING 
    (
        node_id varchar,
        node_id_type varchar,
        user_main_id varchar,
...
;  
   ...
   INSERT INTO MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_ACTIVE_MAPPING (node_id, node_id_type, user_main_id, valid_at, first_seen_at, user_main_id_dist, stitching_active) 
            SELECT
                id1 AS node_id,
            ...
            FROM
                MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_EDGES
            UNION ALL
            SELECT
                id2 AS node_id,
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_ACTIVE_MAPPING AS (
    SELECT
        node_id,
        node_id_type,
        user_main_id,
    ...
    FROM (
        ...
        FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_ACTIVE_MAPPING
    )
    WHERE row_number = 1
);  
   ...
   INSERT INTO MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_FINISHED_MAPPING (node_id, node_id_type, user_main_id, valid_at, first_seen_at, user_main_id_dist, stitching_active) 
        SELECT
            node_id,
            node_id_type,
            user_main_id,
    ...
    DELETE FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_250_INTERNAL_ACTIVE_MAPPING WHERE stitching_active = 0;
