...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_253_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION AS (
            ...
            SELECT
                user_main_id,
                 datediff(day, date(min(timestamp)), date('2023-12-22 09:30:21')) 
   ...
   CREATE OR REPLACE TEMPORARY TABLE ML_TEST1.MATERIAL_USER_VAR_TABLE_30B422F7_253NEW AS (
              ...
              LEFT JOIN MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_253_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_253_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION;  
