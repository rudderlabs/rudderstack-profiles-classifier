   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_IS_CHURNED_90_DAYS_AD23AB0A_255_INTERNAL_EV_IS_CHURNED_90_DAYS AS (
            
                SELECT * FROM (
            SELECT
                user_main_id,
                case when Material_user_var_table_30b422f7_255.days_since_last_seen > 90 then 1 else 0 end
   ...
   CREATE OR REPLACE TEMPORARY TABLE ML_TEST1.MATERIAL_USER_VAR_TABLE_30B422F7_255NEW AS (
              ...
              LEFT JOIN MATERIAL_IS_CHURNED_90_DAYS_AD23AB0A_255_INTERNAL_EV_IS_CHURNED_90_DAYS USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_IS_CHURNED_90_DAYS_AD23AB0A_255_INTERNAL_EV_IS_CHURNED_90_DAYS;  
