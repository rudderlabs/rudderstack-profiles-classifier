...
;  
   ...
   CREATE OR REPLACE TABLE MATERIAL_RSTRACKS_VAR_TABLE_4E18CE2D_264 AS (
        SELECT 
        left(sha1(random()::varchar),32) AS input_row_id, ML_TEST1.Material_rsTracks_13d0f24a_264.*
        ...
        FROM ML_TEST1.Material_rsTracks_13d0f24a_264
                            LEFT JOIN ML_TEST1.Material_rudder_user_id_stitcher_9cc87c26_264 AS TempIdsAlias_user_1
                            ON user_id = TempIdsAlias_user_1.other_id
                            AND 'user_id' = TempIdsAlias_user_1.other_id_type
                        
                            LEFT JOIN ML_TEST1.Material_rudder_user_id_stitcher_9cc87c26_264 AS TempIdsAlias_user_2
