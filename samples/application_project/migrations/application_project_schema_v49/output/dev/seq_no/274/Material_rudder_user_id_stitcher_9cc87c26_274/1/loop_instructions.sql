   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_274_INTERNAL_ACTIVE_MAPPING AS (
        ...
        FROM (
            ...
            FROM
                MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_274_INTERNAL_ACTIVE_MAPPING
            )
        )
    );  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_274_INTERNAL_ACTIVE_MAPPING AS (
    ...
    INSERT INTO MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_274_INTERNAL_FINISHED_MAPPING (
