...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_277_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION AS (
            ...
            SELECT
                user_main_id,
                 datediff(day, date(min(timestamp)), date('2023-12-23 13:14:55')) 
   ...
   CREATE OR REPLACE TEMPORARY TABLE ML_TEST1.MATERIAL_USER_VAR_TABLE_30B422F7_277NEW AS (
              ...
              LEFT JOIN MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_277_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_DAYS_SINCE_ACCOUNT_CREATION_A9A73771_277_INTERNAL_EV_DAYS_SINCE_ACCOUNT_CREATION;  
