   ...
   CREATE OR REPLACE VIEW MATERIAL_MAIN_ID_STITCHED_FEATURES_60617727_279 AS 
...
/* endMacros */
    ...
    , distinct_served_ids AS (
        ...
        FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279
            ...
            ,Material_user_var_table_30b422f7_279_ID_MERGED AS (
                ...
                SELECT DISTINCT MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279.other_id AS main_id
                ...
                WHERE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279.other_id_type = 'main_id'
    ...
    distinct_served_ids
            ...
            ON Material_user_var_table_30b422f7_279_ID_MERGED.main_id = distinct_served_ids.main_id
            ...
            ON Material_shopify_churn_39d922f5_279_ID_MERGED.main_id = distinct_served_ids.main_id
            ...
            ON Material_churn_90_days_model_b78d19f2_279_ID_MERGED.main_id = distinct_served_ids.main_id
