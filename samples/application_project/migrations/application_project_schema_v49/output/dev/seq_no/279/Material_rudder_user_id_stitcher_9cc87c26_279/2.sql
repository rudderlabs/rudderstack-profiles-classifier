   ...
   CREATE OR REPLACE TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_MAPPING AS SELECT node_id, node_id_type, user_main_id, valid_at, first_seen_at, user_main_id_dist, stitching_active FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_FINISHED_MAPPING UNION ALL SELECT node_id, node_id_type, user_main_id, valid_at, first_seen_at, user_main_id_dist, stitching_active FROM MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_ACTIVE_MAPPING;  

/* Update the main_id for a cluster to be the one generated by the earliest id seen in that cluster */


   CREATE OR REPLACE TABLE MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_MAPPING AS 
    SELECT
        node_id,
        node_id_type,
 ...
 AS generated_user_main_id,
        ...
        FROM
            MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_MAPPING
        )
;  


   CREATE OR REPLACE VIEW MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279 AS 
    WITH ranked_mappings AS (
        WITH ranked_mappings_with_occurance_count AS (
            WITH temp_ranked_mapping AS (
                ...
                FROM  ML_TEST1.MATERIAL_RUDDER_USER_ID_STITCHER_9CC87C26_279_INTERNAL_MAPPING
