...
;  
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_9BE857A4_222_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES AS (
   ...
   CREATE OR REPLACE TEMPORARY TABLE MATERIAL_USER_VAR_TABLE_CFC56553_222NEW AS (
              ...
              LEFT JOIN MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_9BE857A4_222_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES USING (user_main_id)
          );  
   ...
   DROP TABLE IF EXISTS MATERIAL_MAX_TIMESTAMP_BW_TRACKS_PAGES_9BE857A4_222_INTERNAL_EV_MAX_TIMESTAMP_BW_TRACKS_PAGES;  
