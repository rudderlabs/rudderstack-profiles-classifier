...
from profiles_rudderstack.schema import EntityKeyBuildSpecSchema, MaterializationBuildSpecSchema
...
class TrainingModel(BaseModelType):
    ...
    def __init__(self, build_spec: dict, schema_version: int, pb_version: str) -> None:
        if "materialization" not in build_spec or "enable_status" not in build_spec["materialization"]:
