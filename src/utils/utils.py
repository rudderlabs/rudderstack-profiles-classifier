...
def generate_material_name(
    material_table_prefix: str, model_name: str, model_hash: str, seq_no: int
) -> str:
    ...
    Args:
        ...
        seq_no (int): sequence number of the material table - determines the timestamp of the material table
...
def split_material_table(material_table_name: str) -> Tuple:
    ...
    try:
        table_suffix = mlower.split(constants.MATERIAL_TABLE_PREFIX)[-1]
