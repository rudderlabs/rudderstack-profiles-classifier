...
class TestTrainTablesInfo(unittest.TestCase):
    ...
    def test_instantiation_with_valid_arguments(self):
        ...
        # Act
        train_tables_info = TrainTablesInfo(feature_table_name, feature_table_date, label_table_name, label_table_date)
    ...
    def test_equality_comparison(self):
        ...
        label_table_name = "label_table"
        label_table_date = 20220101
        train_tables_info_1 = TrainTablesInfo(feature_table_name, feature_table_date, label_table_name, label_table_date)
        train_tables_info_2 = TrainTablesInfo(feature_table_name, feature_table_date, label_table_name, label_table_date)
    ...
    def test_inequality_comparison(self):
        ...
        label_table_date = 20220101
        train_tables_info_1 = TrainTablesInfo(feature_table_name, feature_table_date, label_table_name, label_table_date)
        train_tables_info_2 = TrainTablesInfo(label_table_name, label_table_date, feature_table_name, feature_table_date)
