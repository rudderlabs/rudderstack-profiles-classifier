...
def train(
    ...
    if warehouse == "snowflake":
        ...
        def train_and_store_model_results_sf(
            ...
            and returns the model id attached with the results generated.
    ...
    train_results_json, arraytype_features, timestamp_columns = processor.train(
        train_procedure, material_names, merged_config
    )
    ...
    column_dict = {
        "arraytype_features": arraytype_features,
