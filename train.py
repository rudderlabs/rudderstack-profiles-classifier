...
from utils import load_yaml, remap_credentials, combine_config, get_date_range, delete_import_files, delete_procedures, get_material_registry_name, get_latest_material_hash, get_material_names, prepare_feature_table, split_train_test, get_classification_metrics, get_best_th, get_metrics, get_label_date_ref, plot_pr_auc_curve, plot_roc_auc_curve, plot_lift_chart, plot_feature_importance, fetch_staged_file, get_output_directory
...
def train(creds: dict, inputs: str, output_filename: str, config: dict) -> None:
    ...
    def train_sp(session: snowflake.snowpark.Session,
        ...
        plot_feature_importance(session, stage_name, shap_importance, 5, f"04-feature-importance-chart.png")
